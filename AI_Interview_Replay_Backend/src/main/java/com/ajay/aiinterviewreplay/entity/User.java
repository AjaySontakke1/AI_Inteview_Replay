package com.ajay.aiinterviewreplay.entity;
...
public class User {
    ...
    // All-args constructor (without ID, useful for creating new users)
    ...
    // All-args constructor (with ID, useful for testing or updates)
